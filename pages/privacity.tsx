    ...
    <Layout>
      ...
      <section className="container grid items-center gap-6 pt-6 pb-8 md:py-10">
        ...
        <div>
          ...
          <ol>
          <li>Introducción
          En Yenda, valoramos tu privacidad y nos comprometemos a proteger tu información personal. Esta política de privacidad explica cómo recopilamos, utilizamos, y protegemos tus datos cuando utilizas nuestra aplicación.</li>
          ...
          <li>Compartición de tu Información
          No vendemos, alquilamos ni compartimos tu información personal con terceros, excepto en las siguientes circunstancias:</li>
          ...
          Implementamos medidas de seguridad técnicas y organizativas adecuadas para proteger tus datos personales contra el acceso, uso o divulgación no autorizados.</li>
          <li>Retención de Datos
          Retenemos tus datos personales durante el tiempo necesario para cumplir con los fines descritos en esta política, a menos que se requiera o permita un período de retención más largo por la ley.</li>
          <li>Tus Derechos
          Tienes derecho a acceder, corregir, eliminar y oponerte al tratamiento de tus datos personales. Para ejercer estos derechos, por favor contacta con nosotros a poleras@yenda.app.</li>
          <li>Cambios a esta Política de Privacidad
          Podemos actualizar esta política de privacidad periódicamente. Te notificaremos sobre cambios significativos publicando la nueva política en nuestra app y/o enviándote una notificación.</li>
          <li>Contacto
          Si tienes preguntas o preocupaciones sobre esta política de privacidad, por favor contáctanos a:
          poleras@yenda.app</li>
          </ol>
